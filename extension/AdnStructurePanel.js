          ...
          markupButton.onClick = function() {
            ...
            arrowMarkup.onClick = function() {
                        ...
                        viewer.loadExtension("Autodesk.Viewing.MarkupsCore").then((ext) => {
                          ...
                          var styleObject = nsu.createStyle(styleAttributes,ext);
                          // styleObject['stroke-color'] = '#363636';
            ...
            textMarkup.onClick = function() {
                ...
                viewer.loadExtension("Autodesk.Viewing.MarkupsCore").then((ext) => {
                  ...
                  var styleAttributes = ['font-size'];
                  var nsu = Autodesk.Viewing.Extensions.Markups.Core.Utils;
                  var styleObject = nsu.createStyle(styleAttributes,ext);
                  styleObject['font-size'] = 50;
                  ext.setStyle(styleObject);
                  Autodesk.Viewing.Extensions.Markups.Core.Utils.showLmvToolsAndPanels(viewer)
                })
    ...
    //get full image
      ...
      console.log(screenshot.src)
        ...
        snapshot() {
          ...
          screenshot.onload = function () {
            viewer.loadExtension('Autodesk.Viewing.MarkupsCore').then(function (markupCore) {
              const markupExtension1 = viewer.getExtension("Autodesk.Viewing.MarkupsCore");
              this.markupStringData = markupExtension1.generateData();
              markupCore.leaveEditMode();
              markupCore.loadMarkups(this.markupStringData,"Layer_1");
              markupCore.showMarkups("Layer_1");
